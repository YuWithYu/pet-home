...
// 设置环境变量
process.env.VUE_APP_TITLE = title || "宠物家管理后台";
process.env.VUE_APP_UPDATE_TIME = time;
process.env.BASE_URL = publicPath;
// 删除这一行，避免覆盖rspack.js中设置的值
// process.env.NODE_ENV = process.env.NODE_ENV || 'development'
process.env.VUE_APP_MOCK_ENABLE = "false"; // 禁用mock，直接调用后端API
process.env.VUE_APP_AUTHOR = "宠物家"; // 设置作者
...
module.exports = {
  ...
  plugins: [
    ...
    new DefinePlugin({
      ...
      "process.env.VUE_APP_MOCK_ENABLE": JSON.stringify("false"), // 开发环境使用真实后端，便于管理员登录
