...
@ApiModel(value = "GroomingAppointment对象", description = "宠物洗护预约")
public class GroomingAppointment {
    ...
    @TableField(exist = false)
    @ApiModelProperty(value = "预约的具体服务项目名称（由 serviceId 关联 grooming_services）")
