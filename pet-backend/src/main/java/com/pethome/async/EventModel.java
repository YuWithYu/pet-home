...
public class EventModel {
    ...
    public EventModel() {}
    public EventModel(EventType type) { this.eventType = type; }
    ...
    public int getEntityUserId() { return entityUserId; }
    public EventModel setEntityUserId(int entityUserId) { this.entityUserId = entityUserId; return this; }
    public Map<String, Object> getData() { return data; }
    public EventModel setData(String key, Object value) { this.data.put(key, value); return this; }
}
