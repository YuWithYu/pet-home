...
var _api = __webpack_require__(/*! ./common/js/api */ 38);
var _util = __webpack_require__(/*! ./common/js/util */ 41);
// @ts-ignore
...
var CustomNavbar = function CustomNavbar() {
  __webpack_require__.e(/*! require.ensure | components/custom-navbar/custom-navbar */ "components/custom-navbar/custom-navbar").then((function () {
    return resolve(__webpack_require__(/*! ./components/custom-navbar/custom-navbar.vue */ 704));
  }).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
};
_vue.default.component('CustomNavbar', CustomNavbar);

// 备案域名已通过：开发者工具、真机预览、正式版统一连线上（无需本地起后端）http://localhost:8080  https://situationship.icu
var API_BASE = 'https://situationship.icu';
_util.util.setApiBaseUrl(API_BASE);
