<template>
  <view class="select-pet-type-container">
    ...
    <!-- 页面内容 -->
    <view class="select-pet-content" :style="{ paddingTop: navBarTotalHeight + 'px' }">
      <!-- 宠物类型选择区域（居中） -->
        ...
        <view class="pet-type-options">
          ...
          >
            <view class="pet-image-container">
              <image src="/static/images/cat-avatar.png" mode="aspectFill" class="pet-image" />
            </view>
            <view class="pet-name">
              <text>猫咪</text>
            </view>
          ...
          >
            <view class="pet-image-container">
              <image src="/static/images/dog-avatar.png" mode="aspectFill" class="pet-image" />
            </view>
            <view class="pet-name">
              <text>狗狗</text>
            </view>
          ...
          >
            <view class="pet-image-container">
              <image src="/static/images/rabbit-avatar.png" mode="aspectFill" class="pet-image" />
            </view>
            <view class="pet-name">
              <text>其他</text>
            </view>
